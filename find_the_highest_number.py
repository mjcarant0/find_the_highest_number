...
var1 = float(int(input("Please input your first number: ")))
var2 = float(int(input("Please input your second number: ")))
var3 = float(int(input("Please input your third number: ")))
var4 = float(int(input("Please input your fourth number: ")))
var5 = float(int(input("Please input your fifth number: ")))
